...
/**
 * Implementación de {@link InterfazEvaluadorCalidad} con el índice de Calinski-Harabasz.
 * @author Yimin Jin
 */
public class CalinskiHarabasz implements InterfazEvaluadorCalidad {
    ...
    /**
     * Evaluda la calidad de un clustering con el índice de Calinski-Harabasz.
     * @param clusters Grupos de respuestas.
     * @param comp Comparador para calcular distancias.
     * @return Un valor positivo comenzando desde el 0. Un valor más alto indica un mejor agrupamiento.
     */
    @Override
