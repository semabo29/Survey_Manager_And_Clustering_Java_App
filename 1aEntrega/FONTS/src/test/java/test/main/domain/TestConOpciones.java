...
public class TestConOpciones {
    ...
    public void testCreadora() {
        ...
        try {
            ...
            assertEquals(1, conOpciones1.getNumRespuestas());
    ...
    public void testSetNumRespuestas() {
        try {
            ...
            conOpciones1.setNumRespuestas(2);
            assertEquals(2, conOpciones1.getNumRespuestas());
        } catch (Exception e) {
            fail("No deberia establecer la excepcion");
        }
        ...
        try {
            ConOpciones conOpciones1 = new ConOpciones(1);
            conOpciones1.setNumRespuestas(0);
