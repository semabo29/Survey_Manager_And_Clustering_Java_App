...
public class TestRespuestaEncuesta {
    ...
    public void testConstructoraExitosa() {
        ...
        assertNotNull(res.getDatosRespuesta());
        assertTrue(res.getDatosRespuesta().isEmpty());
    }
    ...
    public void testAddRespuesta() {
        ...
        assertEquals(1, res.getDatosRespuesta().size());
        assertEquals(mockDatos1, res.getDatosRespuesta().get(1));

        res.addRespuesta(1, mockDatos2);
        assertEquals(1, res.getDatosRespuesta().size());
        assertEquals(mockDatos2, res.getDatosRespuesta().get(1));
    }
